...
CREATE TABLE IF NOT EXISTS `pipingDB`.`calulations` (
  ...
  `cisnienieObliczeniowe` DOUBLE NOT NULL,
  `tempObliczeniowa` INT NOT NULL,
...
START TRANSACTION;
USE `pipingDB`;
INSERT INTO `pipingDB`.`users` (`idusers`, `login`, `password`, `idroles`) VALUES (100, 'admin', 'admin', 1);
INSERT INTO `pipingDB`.`users` (`idusers`, `login`, `password`, `idroles`) VALUES (101, 'pm', 'pm', 3);
INSERT INTO `pipingDB`.`users` (`idusers`, `login`, `password`, `idroles`) VALUES (102, 'eng', 'eng', 5);
